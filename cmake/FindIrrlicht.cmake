...
if (IRRLICHT_LIBRARIES AND IRRLICHT_INCLUDE_DIRS)
    ...
    if (APPLE)
        set(COCOA_LIBRARY "-framework Cocoa" CACHE STRING "Cocoa framework for OSX")
        set(COREVIDEO_LIBRARY "-framework CoreVideo" CACHE STRING "CoreVideo framework for OSX")
        set(IOKIT_LIBRARY "-framework IOKit" CACHE STRING "IOKit framework for OSX")
    endif(APPLE)
